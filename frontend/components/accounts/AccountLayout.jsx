...
export default function AccountLayout({ children }) {
  ...
  const syncSearchToPage = (query) => {
    ...
    const pageRoot = document.querySelector('[data-panel-content="account"]')
    ...
    window.dispatchEvent(new CustomEvent('panel-global-search', { detail: { panel: 'account', query } }))
  ...
  return (
    <div style={s.layout}>
      ...
      <main style={{ ...s.main, paddingLeft: collapsed ? 88 : 256 }}>
        ...
        <div style={s.content} data-panel-content="account">
          {children}
        </div>
      </main>
    </div>
